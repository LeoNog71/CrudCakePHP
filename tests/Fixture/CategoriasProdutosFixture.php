...
class CategoriasProdutosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nome_categoria' => ['type' => 'string', 'length' => 220, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-06-27 06:40:15',
                'modificado' => '2018-06-27 06:40:15'
            ],
        ];
        parent::init();
    }
